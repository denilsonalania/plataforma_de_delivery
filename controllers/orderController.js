...
// Controlador para obtener pedidos aceptados
...
// Controlador para aceptar un pedido
...
// Controlador para obtener detalles de un pedido
...
// Controlador para obtener pedidos asignados
...
// Controlador para marcar un pedido como entregado
...
// Controlador para obtener el estatus del usuario
...
// Controlador para girar la ruleta
...
// Controlador para obtener premios disponibles
exports.getAvailablePrizes = async (req, res) => {
    try {
        const userId = req.user.id;
...
// Controlador para crear un pedido con un premio
exports.createOrderWithPrize = async (req, res) => {
...
// Nueva función: Controlador para obtener los pedidos de un usuario
